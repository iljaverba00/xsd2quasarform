...
<xsl:stylesheet version="1.0"
    ...
    <xsl:output method="html" omit-xml-declaration="yes" indent="yes" version="5.0"
    ...
    <xsl:param name="config-callback">(function(str){window.parent.postMessage(str,'*');console.log(str)})</xsl:param>
